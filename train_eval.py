...
from utils import printLines, loadLinesAndConversations, extractSentencePairs, normalizeString, indexesFromSentence
...
# For training single batch of inputs
...
# Trains for n_iteration and saves model allowing us to continue training later
def trainIters(model_name, voc, pairs, encoder, decoder, encoder_optimizer, decoder_optimizer, 
                embedding, encoder_n_layers, decoder_n_layers, hidden_size, save_dir, n_iteration, 
                batch_size, print_every, save_every, clip, corpus_name,teacher_forcing_ratio, loadFilename = "tr"):
